...
export const LabData: Labs[] = [
  ...
  },
  {
    ...
    image_urls: [
      ...
      'https://tuyensinh.vanlanguni.edu.vn/wp-content/uploads/2020/07/1-5.jpg',
    ],
    teacher_ids: ['2', '3'],
  ...
  },
  {
    ...
    image_urls: [
      ...
      'https://vkist.gov.vn/vkist-media/22/3/2/cam-bien-sinh-hoc-hau-2.jpg',
    ],
    teacher_ids: ['9', '11'],
    language: 'english',
    created_at: new Date(new Date().setDate(new Date().getDate() - 13)),
  ...
  },
  {
    ...
    image_urls: [
      ...
      'https://huongnghiep.hocmai.vn/wp-content/uploads/2021/12/2-29.png',
    ],
    teacher_ids: ['7', '8'],
  ...
  },
  {
    ...
    image_urls: [
      ...
      'https://ts.huit.edu.vn/tttstt/images/nganh-dao-tao-dh/nganh-quan-ly-nang-luong.jpg',
    ],
    teacher_ids: ['54', '44'],
    language: 'english',
    created_at: new Date(new Date().setDate(new Date().getDate() - 14)),
  ...
  },
  {
    ...
    image_urls: ['https://bmi.edu.vn/uploads/images/images974329_ketoan.jpg'],
    teacher_ids: ['52', '30'],
    language: 'english',
    created_at: new Date(new Date().setDate(new Date().getDate() - 16)),
    updated_at: new Date(new Date().setDate(new Date().getDate() - 10)),
    is_open: true,
  ...
  },
  {
    ...
    image_urls: [
      ...
      'https://cdn.thoibaonganhang.vn/stores/news_dataimages/minhvl/102020/14/09/4311_apple-brainstorming-camera-908288.jpg',
    ],
    teacher_ids: ['22'],
    language: 'english',
    created_at: new Date(new Date().setDate(new Date().getDate() - 15)),
  ...
  },
  {
    ...
    teacher_ids: ['42', '56'],
    language: 'english',
    created_at: new Date(new Date().setDate(new Date().getDate() - 17)),
    updated_at: new Date(new Date().setDate(new Date().getDate() - 10)),
    is_open: true,
    number_of_students: 20,
    salary: 35,
  ...
  },
  {
    ...
    image_urls: [
      ...
      'https://lilama2.edu.vn/Media/Images/cokhi/CKXD1.jpg',
    ],
    teacher_ids: ['10', '39'],
    created_at: new Date(new Date().setDate(new Date().getDate() - 10)),
    updated_at: new Date(new Date().setDate(new Date().getDate() - 4)),
  ...
  },
  {
    ...
    teacher_ids: ['1', '45'],
    created_at: new Date(new Date().setDate(new Date().getDate() - 15)),
    updated_at: new Date(new Date().setDate(new Date().getDate() - 11)),
    is_open: true,
    number_of_students: 20,
    salary: 35,
